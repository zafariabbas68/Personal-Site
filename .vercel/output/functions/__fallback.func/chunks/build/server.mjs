...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-gtN4eTIf.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BqcKCTDW.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ctx5Yj1Z.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-06ECz2kA.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-CbefBsS0.mjs')
  },
  {
    name: "education",
    path: "/education",
    component: () => import('./education-D-LbHa-b.mjs')
  },
  {
    name: "experience",
    path: "/experience",
    component: () => import('./experience-c5xuSQQu.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BFKvlUkd.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BmgL4Orc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Be2ohEjq.mjs'));
...
export { _export_sfc as _, useSeoMeta as a, useAppConfig as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, asyncDataDefaults as e, createError as f, useRouter as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, useHead as u };
